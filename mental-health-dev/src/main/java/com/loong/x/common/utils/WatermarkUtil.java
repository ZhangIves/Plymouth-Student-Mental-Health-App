...
public class WatermarkUtil {
    ...
    public static String manageWatermark(Image image, Integer type, String watermark) {
        ...
        // 定义存储的地址
        String tarImgPath = "E:\\W\\code\\ems\\ems-dev\\target\\classes\\static\\uploadImages\\2024042711401148-water.png";
        // 输出图片
        try {
    ...
    public static void main(String[] args) {
        ...
        // 本地图片路径：
        String localPath = "E:\\W\\code\\ems\\ems-dev\\target\\classes\\static\\uploadImages\\2024042711401148.png";
        // 网络图片地址：
