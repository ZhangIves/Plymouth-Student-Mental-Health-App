...
public interface SysUserDao {
    ...
    List<SysUserDto> queryAllByLimitWithRole(String fullName,String phone,Integer sex,Integer status,String roleName,String username,String remark, @Param("pageable") Pageable pageable);


    long countPage(SysUserDto sysUser);
