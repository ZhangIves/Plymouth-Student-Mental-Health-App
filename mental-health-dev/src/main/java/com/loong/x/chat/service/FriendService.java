...
public interface FriendService extends IService<Friend> {
     ...
     */
    FriendVo add(FriendVo friendVo,Long userId);
     ...
     */
    IPage<FriendVo> page(FriendVo friendVo, Integer current, Integer size,Long userId);
     ...
     * @return net.javadog.chat.model.vo.FriendVo
     */
    FriendVo detail(String friendId,Long userId);
