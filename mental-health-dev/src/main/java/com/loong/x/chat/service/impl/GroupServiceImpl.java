...
import com.loong.x.chat.mapper.GroupMapper;
import com.loong.x.chat.model.entity.Group;
import com.loong.x.chat.model.entity.GroupMsg;
...
public class GroupServiceImpl extends ServiceImpl<GroupMapper, Group> implements GroupService {
    ...
    @Override
    public GroupVo add(GroupVo groupVo,Long userId) {
    ...
    @Override
    public IPage<GroupVo> page(GroupUserVo groupUserVo, int current, int size,Long userId) {
     ...
     * @return: void
     */
    private void buildGroupUser(Group group, SysUser userInfo) {
        // 组员表中加入一条信息
        ...
        // 群组员昵称
        groupUser.setUserNickname(userInfo.getFullName() + "(群主)");
        // 群组员头像
