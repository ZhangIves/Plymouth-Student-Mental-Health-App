package com.loong.x.chat.websocket.config;

import com.loong.x.chat.websocket.interceptor.SocketInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        registry.addEndpoint("/clientApi/socket").addInterceptors(new SocketInterceptor())
                .setAllowedOrigins("*");
    }
