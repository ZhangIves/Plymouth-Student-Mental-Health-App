...
CREATE TABLE `goods`  (
  ...
  `ageing` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `goods_order`  (
  ...
  `count` bigint(10) NULL DEFAULT NULL,
  `total_price` bigint(255) NULL DEFAULT NULL,
  `goods` bigint(255) NULL DEFAULT NULL,
...
CREATE TABLE `user`  (
  ...
  `roles` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `avatar` varchar(225) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '头像',
  `status` int(11) NULL DEFAULT 1 COMMENT '状态 0:禁用，1:正常',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_username`(`username`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16883766844541 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '用户信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (16883766844501, 'admin', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '3123', '1', '213', '1', NULL, 1, '2023-08-02 17:31:55', '2023-10-10 16:35:35');
INSERT INTO `user` VALUES (16883766844538, '李晨旭', 'lcx', 'e10adc3949ba59abbe56e057f20f883e', '18238905215', '男', '11111', 'user', NULL, 1, '2023-08-09 15:46:04', '2023-10-10 14:45:00');
INSERT INTO `user` VALUES (16883766844539, '彭孟寒', 'pmh', 'e10adc3949ba59abbe56e057f20f883e', '13392362616', '男', '11111', 'user', NULL, 1, '2023-08-09 15:46:26', '2023-08-09 15:46:26');
INSERT INTO `user` VALUES (16883766844540, '方诗', 'fs', 'e10adc3949ba59abbe56e057f20f883e', '17729782907', '女', '11111', 'user', NULL, 1, '2023-08-09 15:46:41', '2023-08-09 16:34:33');
...
CREATE TABLE `wallet`  (
  ...
  `user_id` bigint(255) NOT NULL COMMENT '外键-用户id',
  `new_income` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '最新收入',
  `count_income` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '总收入',
  `principal` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '本金',
