    ...
    <view class="container">
      <view class="avatar">
        ...
        >
          ...
          <u-col span="9">
            <u-col span="12">
              <u--text  type="primary" :text="user.fullName" bold></u--text>
            </u-col>
            <u-col span="12">
              <u--text :type="user.sex=='1'?'error':'success'" :text="user.sex==0?'Female': 'Male'" :suffixIcon="user.sex=='2'?'woman':'man'"></u--text>
            </u-col>
          </u-col>
        </u-row>
      </view>
      <view class="main">
        ...
        >
          ...
          >
            ...
            <text class="u-collapse-content">{{user.intro?user.intro:'Come on, let me introduce you'}}</text>
          </u-collapse-item>
<!--          <u-collapse-item
              title="生日"
              name="birthday"
        ...
        <view v-if="notMe">
          <view class="row" v-if="isFriend">
            <u-button text="Send Message" type="success" @click="send" customStyle="margin-top: 50px"></u-button>
...
export default {
  ...
  methods: {
    ...
    async friendInfo(){
      ...
      this.user.fullName = friend.nickname
      this.friend = friend
    },
    // 去聊天
    send(){
