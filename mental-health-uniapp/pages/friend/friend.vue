<template>
	<view>
		<!-- <navbar title="Doctor List" back="true" @search="search" @change="change" @cancel="cancelSearch"></navbar> -->
		<navbar title="Doctor List" :isBack="false" type="second" ></navbar>
    <view class="container">
		    <u-index-list :indexList="indexList">
			<view slot="header" class="list" v-if="false">
				<view class="list__item" @click="handle(0)">
					<u-avatar shape="square" size="35" icon="man-add" fontSize="26" randomBgColor></u-avatar>
					<text class="list__item__user-name">我添加的</text>
				</view>
				<u-line></u-line>
				<view class="list__item" @click="handle(1)">
					<u-avatar shape="square" size="35" icon="plus-people-fill" fontSize="26" randomBgColor></u-avatar>
					<text class="list__item__user-name">想加我的 </text>
					<u-badge style="margin-left: 5px" type="error" :value="invitationNum"></u-badge>
				</view>
				<view class="list__item" @click="handle(2)">
					<u-avatar shape="square" size="35" icon="grid-fill" fontSize="26" randomBgColor></u-avatar>
					<text class="list__item__user-name">组队群聊</text>
					<u-badge style="margin-left: 5px" type="error" :value="invitationNum"></u-badge>
				</view>
				<u-line></u-line>
			</view>
      ...
      <u-empty v-if="friendList.length==0" marginTop="200upx" mode="list" text="Empty" icon="http://cdn.uviewui.com/uview/empty/list.png">
      </u-empty>
    </view>
	</view>
</template>
