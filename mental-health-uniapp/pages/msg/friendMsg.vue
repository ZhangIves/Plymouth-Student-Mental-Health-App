  ...
  <view class="friendMsg">
    ...
    <view class="container">
      ...
      <mescroll-body :fixed="false" class="mescroll" :safearea="true" ref="mescrollRef" bottom="108upx" @init="mescrollInit" :down="downOption" @down="downEvent" :up="upOption">
          <!-- 无更多消息 -->
          <view v-if="isEnd" class="msg-end">There is no further news</view>
...
export default {
  ...
  data() {
    return {
      ...
      nickname: '',
      // 我的头像
      myAvatar:'/static/img/avatar-1.jpeg',
      // 朋友头像
      friendAvatar:'/static/img/avatar-1.jpeg',
      // 是否最后
      downOption:{
        // 显示下拉刷新的进度条
  ...
  methods: {
    ...
    async avatar(){
      ...
      const user = res.data
      this.myAvatar = user.avatar?user.avatar:'/static/img/avatar-1.jpeg'
      // 获取朋友用户信息
      ...
      this.friendAvatar = friend.avatar?friend.avatar:'/static/img/avatar-1.jpeg'
    },
    // 转化文字
    covertText(msg){
